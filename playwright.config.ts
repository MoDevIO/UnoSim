...
export default defineConfig({
  ...
  webServer: {
    ...
    command: `PORT=${basePort} SIMULATION_MAX_CONCURRENT=5 SANDBOX_START_MAX_CONCURRENT=8 VITE_DISABLE_TOASTS=true VITE_DISABLE_HMR=true DISABLE_COMPILE_GATEKEEPER=true npm run dev:e2e`,
