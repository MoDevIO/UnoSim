/**
 * Arduino Type Definitions (Stateless Helper Classes)
 * 
 * Extracted from arduino-mock.ts for better modularity and reusability.
 * These types are used in the Arduino mock implementation and have no 
...
public:
    ...
    String(char c) : str(1, c) {} // Constructor from char
...
// Runtime I/O Registry tracking - stateless structs
struct IOOperation {
    int line;
